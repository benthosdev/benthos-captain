...
//+kubebuilder:rbac:groups=benthos-captain.benthos.dev,resources=pipelines,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=benthos-captain.benthos.dev,resources=pipelines/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=benthos-captain.benthos.dev,resources=pipelines/finalizers,verbs=update

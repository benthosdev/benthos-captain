...
// +kubebuilder:webhook:verbs=create;update,path=/validate-benthos.dev-v1beta1-pipeline,mutating=false,failurePolicy=fail,groups=benthos.dev,resources=pipelines,versions=v1beta1,name=vpipeline.kb.io
